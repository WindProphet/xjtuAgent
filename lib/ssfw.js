        ...
        if (typeof sel == "object") {
          request
            ...
            .end((err, res) => {
              let $ = cheerio.load(res.text)
              let form = $('#pjform')
              // console.log($('table', form).eq(0).text());
              // console.log(form.attr('action'))
              // console.log(`wid_pgjxb = ${$('input#wid_pgjxb', form).attr('value')}`);
              // console.log(`wid_pjzts = ${$('input#wid_pjzts', form).attr('value')}`);
